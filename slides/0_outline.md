...
<tbody>
  ...
  <tr>
    <td class="tg-mevj">29 ноября</td>
    <td class="tg-nqm6">14:30</td>
    <td class="tg-e4vo">Лекция 4: Зрительное восприятие и цвет</td>
  </tr>
  <tr>
    <td class="tg-1p0a">2 декабря</td>
    <td class="tg-jdzo">18:10</td>
    <td class="tg-o7ju">Лекция 5: Различение визуальной информации</td>
  </tr>
  <tr>
    <td class="tg-1p0a">2-6 декабря</td>
    <td class="tg-jdzo">?</td>
  ...
  <tr>
    <td class="tg-1p0a">9 декабря</td>
    <td class="tg-jdzo">18:10</td>
    <td class="tg-o7ju">Лекция 6: Визуализация геопространственных данных</td>
  </tr>
  <tr>
...
#### Шаги для выполнения задания:
  ...
  7. (При желании) Представьте ваш мини-проект на финальном занятии факультатива (дата будет объявлена позднее)